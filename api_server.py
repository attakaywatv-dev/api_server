...
app = Flask(__name__)
CORS(app, origins=[
    "https://starlit-trifle-7408ae.netlify.app",  # Your frontend domain
...
WEBHOOK_URL = os.getenv("WEBHOOK_URL", "https://socialmediaboostorder-production.up.railway.app/verify_callback")
